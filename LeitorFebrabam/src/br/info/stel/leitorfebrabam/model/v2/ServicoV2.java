...
public class ServicoV2 {
    ...
    private String dtaServico;
    private String cnlLocalidadeChamada;
    ...
    private String conjugadoTelefoneChamado;
    ...
    public String getDtaServico() {
        return dtaServico;
    }

    public void setDtaServico(String dtaServico) {
        this.dtaServico = dtaServico;
    }

    public String getCnlLocalidadeChamada() {
        return cnlLocalidadeChamada;
    }

    public void setCnlLocalidadeChamada(String cnlLocalidadeChamada) {
    ...
    public String getConjugadoTelefoneChamado() {
        return conjugadoTelefoneChamado;
    }

    public void setConjugadoTelefoneChamado(String conjugadoTelefoneChamado) {
        this.conjugadoTelefoneChamado = conjugadoTelefoneChamado;
    }
